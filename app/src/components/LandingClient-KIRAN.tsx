      ...
      <main style={{
        ...
        <style>{`
          *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .lp-footer-bottom { max-width:1280px; margin:0 auto; padding:32px 40px; display:flex; align-items:center; justify-content:space-between; gap:16px; flex-wrap:wrap; }
          .lp-footer-left { display: flex; align-items: center; gap: 20px; flex-wrap: wrap; }
          .lp-footer-logo-small { display: flex; align-items: center; gap: 8px; text-decoration: none; }
          .lp-footer-logo-name-small { font-size: 14.5px; font-weight: 800; background:linear-gradient(135deg,#fb923c,#f97316,#fbbf24); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text; }
          .lp-footer-copy { font-size:13px; color:var(--lp-footer-muted); }
          .lp-footer-bottom-links { display:flex; align-items:center; gap:28px; }
          .lp-footer-bottom-link { font-size:13px; color:var(--lp-footer-text); text-decoration:none; transition:color 0.15s; font-weight: 500; }
          ...
          @media (max-width: 640px) {
            ...
            .lp-footer-bottom { flex-direction:column; align-items:flex-start; padding:28px 24px; gap:20px; }
            .lp-footer-left { flex-direction:column; align-items:flex-start; gap:8px; }
          }
        `}</style>
        ...
        <footer className="lp-footer-wrap">
          <div className="lp-footer-bottom">
            <div className="lp-footer-left">
              <Link href="/" className="lp-footer-logo-small">
                <Image src="/logo.jpeg" alt="Distilled" width={20} height={20} style={{ objectFit: "contain", borderRadius: "4px" }} />
                <span className="lp-footer-logo-name-small">Distilled</span>
              </Link>
              <span className="lp-footer-copy">© {new Date().getFullYear()} Distilled. All rights reserved. Built with ♥ for curious minds.</span>
            </div>
            ...
            <div className="lp-footer-bottom-links">
              ...
              <a href="mailto:support@distilled.blog" className="lp-footer-bottom-link">Contact</a>
            </div>
          </div>
        </footer>
      </main>
